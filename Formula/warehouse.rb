class Warehouse < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/paulmeller/warehouse-cli/releases/download/v0.2.0/warehouse-macos-arm64.tar.gz"
      sha256 ""
    else
      url "https://github.com/paulmeller/warehouse-cli/releases/download/v0.2.0/warehouse-macos-x86_64.tar.gz"
      sha256 ""
    end
  end
